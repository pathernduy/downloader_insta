...
Future<Response> mrnewton2StoryApiRequest(String paramUsername)async{
  var response = null;
  for(var key in rapidAPIKeys.Keys){
    response = await Dio().get(
      //https://instagram-story-downloader-media-downloader.p.rapidapi.com/story/index?url=nguyenphuongtrang.16
