...
Future<Response> xudoberdigayratovStoryApiRequest(String paramUsername)async{
  String urlAPI = "https://www.instagram.com/stories/"+paramUsername +"/";
  var response = null;
  for(var key in rapidAPIKeys.Keys){
    response = await Dio().get(
        'https://instagram-downloader-download-instagram-videos-stories3.p.rapidapi.com/instagram/v1/get_info/?url=$urlAPI',
