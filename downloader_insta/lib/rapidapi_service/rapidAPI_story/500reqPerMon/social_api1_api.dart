...
Future<Response> socialapiStoryApiRequest(String paramUsername)async{
  String urlAPI = "https://www.instagram.com/stories/"+paramUsername +"/";
  String parsedData = Uri.encodeComponent(urlAPI);
  var response = null;
  for(var key in rapidAPIKeys.Keys){
    response = await Dio().get(
        'https://instagram-scraper-api2.p.rapidapi.com/v1/stories?username_or_id_or_url=$parsedData',
