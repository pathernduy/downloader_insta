...
Future<http.Response> maatootzPostApiRequest(String paramUsername)async{
  //email phatdinh.work@gmail.com
  final url = Uri.parse(
      'https://instagram-downloader-download-instagram-videos-stories.p.rapidapi.com/index?url=$paramUsername'
  );
