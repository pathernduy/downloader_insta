...
Future<Response> maatootzPostApiRequest(String paramLink)async{
  String parsedData = Uri.encodeComponent(paramLink);
  var response = null;
  for(var key in rapidAPIKeys.Keys){

    response = await Dio().get(
      //https://instagram-story-downloader-media-downloader.p.rapidapi.com/index?url=https%3A%2F%2Fwww.instagram.com%2Fp%2FCzgn3v4pkcj%2F
        'https://instagram-story-downloader-media-downloader.p.rapidapi.com/index?url=$parsedData',
