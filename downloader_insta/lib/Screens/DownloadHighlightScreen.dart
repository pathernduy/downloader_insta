...
class DownloadHighlightScreen extends StatefulWidget {
  const DownloadHighlightScreen({super.key});

  @override
  State<DownloadHighlightScreen> createState() => _DownloadVideoScreenState();
}

class _DownloadVideoScreenState extends State<DownloadHighlightScreen> {
  BannerAd? _bannerAd;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Download Highlight'),
      ),
                        ...
                        if (postUrlController.text.contains("/stories/")) {
                          ...
                          showDialog<String>(
                            ...
                            builder: (BuildContext context) =>
                                ErrorExceptionWidget('Wrong url type','You must have the link like this: https://www.instagram.com/stories/highlights/story-id/'),
